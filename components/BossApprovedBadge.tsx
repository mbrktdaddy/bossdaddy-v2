...
export default function BossApprovedBadge({ size = 'sm', variant = 'page' }: Props) {
  ...
  if (size === 'lg') {
    return (
      <div className="shrink-0 rotate-[-3deg]" aria-label="Boss Daddy Approved">
        <div className="w-28 h-28 rounded-full bg-accent flex flex-col items-center justify-center shadow-xl shadow-orange-950/20 ring-1 ring-orange-400/60">
  ...
  if (variant === 'card') {
    return (
      <div className="rotate-[-3deg]" aria-label="Boss Daddy Approved">
        <div className="flex flex-col items-center justify-center px-3 py-2 bg-accent rounded-lg shadow-lg shadow-stone-900/40 ring-1 ring-orange-400/40">
  ...
  return (
    <div className="rotate-[-2deg] shrink-0" aria-label="Boss Daddy Approved">
      <div className="flex flex-col items-center justify-center px-3 py-1.5 bg-accent rounded-lg shadow-md shadow-orange-950/15 ring-1 ring-orange-400/60">
