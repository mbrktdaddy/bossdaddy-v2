...
export default function ShareButtons({ title }: Props) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      ...
      <button
        onClick={shareX}
        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-prose-muted hover:text-prose bg-surface border border-soft hover:border-strong rounded-lg transition-colors"
      >
