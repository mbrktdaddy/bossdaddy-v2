...
export default function ShareButtons({ title }: Props) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      <span className="text-xs text-prose-faint uppercase tracking-wide font-medium">Share</span>

      <button
        onClick={shareX}
        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-prose-muted hover:text-white bg-surface border border-soft hover:border-gray-600 rounded-lg transition-colors"
      >
