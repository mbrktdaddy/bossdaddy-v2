...
export default function AskBossFab() {
  ...
  return (
    <div className="hidden md:flex fixed bottom-6 right-6 z-40 items-center gap-2.5">
      <span className="bg-surface border border-soft rounded-full px-3.5 py-2 text-xs font-bold text-prose">
        Ask the Boss
      </span>
      <Link
        href="/tools/the-boss"
        aria-label="Ask the Boss — the AI concierge"
        className="w-14 h-14 rounded-full bg-accent hover:bg-accent-hover text-white flex items-center justify-center ring-4 ring-accent/20 transition-colors"
      >
