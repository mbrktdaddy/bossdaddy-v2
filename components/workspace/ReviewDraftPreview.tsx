      ...
      <div className="px-5 py-6 space-y-5 overflow-y-auto max-h-[calc(100vh-180px)]">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            {cons.length > 0 && (
              <div className="bg-red-50 rounded-xl p-3">
                <p className="text-xs text-red-700 font-bold uppercase tracking-wide mb-2">✗ Bad</p>
                <ul className="space-y-1">
        ...
        {(bestFor.length > 0 || notFor.length > 0) && (
          <div className="grid grid-cols-2 gap-3">
            ...
            {notFor.length > 0 && (
              <div className="bg-surface rounded-xl p-3">
                <p className="text-xs text-red-700 uppercase tracking-widest font-semibold mb-2">Not For</p>
                <ul className="space-y-1">
