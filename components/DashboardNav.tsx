...
const NAV_SECTIONS: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/admin/demand', label: 'Gear Demand', adminOnly: true,
      ...
      { href: '/dashboard/admin/reports', label: 'Reports', adminOnly: true,
    ...
    <>
      ...
      <div className="px-5 py-5 border-b border-soft space-y-3">
        ...
        <div className="flex items-center justify-between gap-2">
          <Link href="/account" onClick={onNav} className="flex items-center gap-2 group min-w-0">
