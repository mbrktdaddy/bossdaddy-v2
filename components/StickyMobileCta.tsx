...
export default function StickyMobileCta({ product }: Props) {
  ...
  return (
    <div
      className={`md:hidden fixed bottom-0 left-0 right-0 z-40 bg-chrome/95 backdrop-blur-md border-t border-soft shadow-2xl shadow-black/10 px-4 pt-3 transition-transform duration-300 ${show ? 'translate-y-0' : 'translate-y-full'}`}
