    ...
    <div className="p-4 sm:p-8 max-w-4xl">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mb-8">
        {[
          ...
          { label: 'Admins',  value: counts.admin,  color: 'text-danger-ink' },
      ...
      <div className="grid grid-cols-3 gap-3 mb-8 text-xs">
        {[
          { role: 'admin',  color: 'text-danger-ink',    bg: 'bg-danger-bg border-danger-line',       desc: 'Full access. Moderate content, manage users.' },
