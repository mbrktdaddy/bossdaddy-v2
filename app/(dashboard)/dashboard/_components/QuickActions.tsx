...
const ACTIONS = [
  {
    ...
    accent: 'text-accent-text-soft bg-accent-tint/30 border-accent-border/40',
  },
  {
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
      {ACTIONS.map((a) => (
        ...
        >
          ...
          <p className="text-sm font-semibold text-white group-hover:text-accent-text-soft transition-colors">{a.label}</p>
