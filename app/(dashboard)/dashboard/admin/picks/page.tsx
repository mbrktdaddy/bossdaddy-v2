...
const TYPE_META: Record<string, { label: string; chip: string }> = {
  general:    { label: 'Pick',       chip: 'bg-orange-950/50 text-orange-300 border-orange-900/40' },
    ...
    <div className="p-4 sm:p-8 max-w-4xl">
      ...
      {!picks?.length ? (
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 text-center">
          <p className="text-gray-400 mb-2">The Vault is empty.</p>
              ...
              >
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-xs text-gray-600 truncate">/{p.slug}</span>
                  </div>
