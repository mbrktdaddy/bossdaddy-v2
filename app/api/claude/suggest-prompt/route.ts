...
Give 3 distinct angles — distinct in which QUESTION sits at the center, not in "beginner vs. expert". Each must be a real question a thoughtful father could land on either side of, not a thesis with a foregone conclusion. No hot takes, no partisan framing. Return your result by calling the submit_suggestions tool. Each suggestion: topic (the piece's central question or title — max 80 chars), angle (one phrase describing the line of inquiry — max 60 chars), and keyPoints (4–6 moves the piece should make — the tension it names, the strongest opposing view it has to steelman, the distinction it turns on, the question it should end on). Keep each keyPoint to one terse phrase under 90 characters — these are notes for the writer, not prose.`
