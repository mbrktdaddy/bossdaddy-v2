...
export async function POST(request: NextRequest) {
  ...
  const prompt = `You are editing an existing Boss Daddy article. Apply ONLY the requested changes — preserve everything else.
...
Important: Only change what the instructions specify. Keep the first-person dad voice throughout.`
  ...
  try {
    ...
    console.error('Article refine error:', err)
