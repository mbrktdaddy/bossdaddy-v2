...
export default function EditorialStandardsPage() {
 ...
 <Link href="/how-we-test" className="py-2 inline-block text-prose-faint hover:text-prose-muted transition-colors">
 How We Test
 </Link>
 <Link href="/affiliate-disclosure" className="py-2 inline-block text-prose-faint hover:text-prose-muted transition-colors">
 Affiliate Disclosure
 </Link>
 <Link href="/privacy-policy" className="py-2 inline-block text-prose-faint hover:text-prose-muted transition-colors">
 Privacy Policy
 </Link>
