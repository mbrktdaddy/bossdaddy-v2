  ...
  return (
    <>
          ...
          <div className="relative max-w-6xl mx-auto px-6 py-20 md:py-28">
            <div className="max-w-2xl">
              ...
              <h1 className="text-5xl md:text-6xl font-black leading-[1.05] tracking-tight mb-6">
                Real Reviews
                <br />
                <span className="text-orange-500">From a Real Dad.</span>
              </h1>
              ...
              <div className="flex items-center gap-4 flex-wrap">
                ...
                <Link href="#newsletter" className="px-6 py-3 text-gray-300 hover:text-white font-medium transition-colors">
                  Join the Crew →
                </Link>
              </div>
            </div>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16 border-b border-gray-800/60">
          ...
          <p className="text-gray-500 text-sm mb-8">Four pillars. All dad-approved.</p>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16 border-b border-gray-800/60">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">Bought, tested, and boss-approved</p>
            </div>
          ...
          <section className="max-w-6xl mx-auto px-6 py-16 border-b border-gray-800/60">
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-gray-500 text-sm mt-1">Guides, tips, and dad wisdom</p>
              </div>
            </div>
        ...
        {/* ── Newsletter ──────────────────────────────────────────────────── */}
        <section id="newsletter" className="max-w-6xl mx-auto px-6 py-16 border-b border-gray-800/60">
          <div className="bg-gradient-to-br from-orange-950/40 to-gray-900 border border-orange-800/30 rounded-3xl px-8 py-12 text-center max-w-2xl mx-auto">
            <p className="text-orange-400 text-sm font-semibold uppercase tracking-widest mb-3">Join the Crew</p>
            <h2 className="text-3xl font-black mb-3">No BS. Just Good Gear.</h2>
            <p className="text-gray-400 mb-8">
              Weekly reviews, deals, and dad-tested picks. No spam — ever.
            </p>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          <div className="bg-gray-900 border border-gray-800 rounded-3xl px-8 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <h2 className="text-2xl font-black mb-2">The Boss Daddy Gear List</h2>
              <p className="text-gray-400 text-sm max-w-md">
                Every product we&apos;ve tested and actually recommend — all in one place.
              </p>
            </div>
            <Link
              href="/reviews"
