  ...
  return (
    <div className="py-24 flex flex-col items-center justify-center px-6 text-center">
      ...
      <div className="flex items-center gap-3 flex-wrap justify-center">
        ...
        <Link href="/guides" className="px-5 py-2.5 bg-surface-raised hover:bg-surface border border-strong text-prose-muted font-semibold rounded-xl transition-colors text-sm">
          All Guides
        </Link>
      </div>
    </div>
