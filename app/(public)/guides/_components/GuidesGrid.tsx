      ...
      {hasMore && (
        <div className="mt-10 text-center">
          <button
            ...
            disabled={isPending}
            className="px-8 py-3 bg-surface rounded-2xl shadow-lg shadow-black/30 text-sm font-semibold text-gray-300 hover:shadow-xl hover:shadow-black/50 hover:text-white transition-all disabled:opacity-50"
          >
