...
export default function GuideCard({ guide: a, priority = false }: { guide: GuideRow; priority?: boolean }) {
  ...
  return (
    <Link
      href={`/guides/${a.slug}`}
      className="group flex flex-col bg-surface rounded-xl overflow-hidden shadow-lg shadow-stone-900/[0.06] hover:shadow-xl hover:shadow-stone-900/[0.10] transition-all duration-200"
    >
      {a.image_url ? (
