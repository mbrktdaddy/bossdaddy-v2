  ...
  return (
    <div className="py-24 flex flex-col items-center justify-center px-6 text-center">
      ...
      <div className="flex items-center gap-3 flex-wrap justify-center">
        ...
        <Link href="/comparisons" className="px-5 py-2.5 bg-surface-raised hover:bg-zinc-700 border border-strong text-prose-muted font-semibold rounded-xl transition-colors text-sm">
          All Comparisons
        </Link>
      </div>
    </div>
