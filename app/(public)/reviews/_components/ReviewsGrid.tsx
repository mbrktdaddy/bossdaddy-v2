      ...
      {hasMore && (
        <div className="mt-10 text-center">
          <button
            ...
            disabled={isPending}
            className="px-8 py-3 bg-surface rounded-xl shadow-lg shadow-black/5 text-sm font-semibold text-prose-muted hover:shadow-xl hover:shadow-black/10 hover:text-prose transition-all disabled:opacity-50"
          >
