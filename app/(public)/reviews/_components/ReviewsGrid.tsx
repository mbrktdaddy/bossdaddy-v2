      ...
      {hasMore && (
        <div className="mt-10 text-center">
          <button
            ...
            disabled={isPending}
            className="px-8 py-3 bg-surface border border-strong hover:border-accent rounded-xl text-sm font-semibold text-prose-muted hover:text-prose transition-all disabled:opacity-50"
          >
