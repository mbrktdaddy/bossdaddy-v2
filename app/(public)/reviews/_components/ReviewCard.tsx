...
export default function ReviewCard({
  ...
  return (
    <article className="group relative flex flex-col bg-surface rounded-xl overflow-hidden shadow-lg shadow-stone-900/[0.06] hover:shadow-xl hover:shadow-stone-900/[0.10] transition-all duration-200">
      {r.image_url ? (
