...
function VaultCardLink({ card }: { card: VaultCard }) {
  ...
  return (
    <Link
      href={href}
      className="group flex flex-col bg-gradient-to-br from-surface to-surface/60 border border-soft rounded-xl overflow-hidden shadow-md shadow-black/30 hover:border-accent-border/40 hover:shadow-lg hover:shadow-black/50 hover:-translate-y-1 transition-all"
    >
