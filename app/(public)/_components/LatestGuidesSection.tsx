        ...
        {guides.map((a, i) => {
          ...
          return (
            ...
            >
              ...
              {a.image_url ? (
                <div className="relative w-20 h-20 sm:w-28 sm:h-24 rounded-2xl overflow-hidden bg-surface-raised shrink-0">
                  <Image
                    src={a.image_url}
                    alt={a.title}
                    fill
                ...
                <div className="w-20 h-20 sm:w-28 sm:h-24 rounded-2xl bg-gradient-to-br from-surface-raised/50 to-surface/40 flex items-center justify-center shrink-0">
                  <svg className="w-7 h-7 text-prose-faint/60" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden>
