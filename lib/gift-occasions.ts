...
export const OCCASIONS: OccasionConfig[] = [
  // ── Major Holidays ─────────────────────────────────────────────────────────
  {
    ...
    shortBlurb: 'Hand-picked gifts for the dad who actually shows up.',
    longBlurb: "Every year I get the same panicked text: 'what should I get dad for Father's Day?' Here's the list — every pick chosen by a dad, not a marketing department. The ones I've tested carry a score. No corporate fluff, just stuff he'll actually pick up again after opening day.",
    metaTitle: "Father's Day Gift Guide — Dad-Picked Gifts | Boss Daddy",
    metaDesc: "Honest Father's Day gift ideas for the dad who actually uses his stuff. Every pick chosen by a real dad — tools, gear, grilling, and beyond.",
  },
  {
    ...
    longBlurb: "Mother's Day deserves more than another candle and a card. This list focuses on gifts mom will reach for again — practical, beautiful, picked by a dad, approved by mom.",
  ...
  },
  {
    ...
    longBlurb: 'Christmas gifts that survive past New Year — picks chosen to earn permanent garage space, not closet exile. Tools, gear, grilling, and lifestyle picks.',
    metaTitle: "Christmas Gift Guide for Dads — Boss Daddy Picks",
    metaDesc: "Honest Christmas gift ideas for dads, husbands, and the men in your life. Every pick chosen by a real dad.",
  },
  {
    ...
    longBlurb: "Valentine's Day gifts that last longer than a dozen roses. Curated picks for him and her — practical, thoughtful, and honestly chosen.",
    metaTitle: "Valentine's Day Gifts — Beyond the Cliché | Boss Daddy",
    metaDesc: "Valentine's Day gift ideas with real staying power. Dad-picked gifts for the people who matter most.",
  },
  {
    ...
    metaDesc: 'New Year gifts for the people setting real goals. Dad-picked gear that actually helps.',
  },
  {
  ...
  },
  {
    ...
    longBlurb: "Thanksgiving picks — whether you're hosting, attending, or just trying to nail the turkey this year. Cooking gear, host gifts, and dad-picked tools.",
    metaTitle: 'Thanksgiving Gift & Hosting Guide | Boss Daddy',
    metaDesc: "Thanksgiving gift ideas, hosting gear, and host gifts dad-picked for actual use.",
  },
  {
    ...
    longBlurb: '4th of July gift ideas — grilling gear, cooler upgrades, party essentials. Built for backyard cookouts.',
    metaTitle: '4th of July Gift & Gear Guide — Boss Daddy',
    metaDesc: 'Grilling gear, party essentials, and gift ideas for 4th of July. Dad-picked gear.',
  },
  {
    ...
    metaDesc: 'Halloween gift ideas, decoration gear, and family-friendly picks, dad-picked.',
  },
  {
    ...
    metaDesc: 'Memorial Day picks for the summer kickoff. Grilling gear, outdoor essentials, dad-picked.',
  },
  ...
  // ── Life Milestones ────────────────────────────────────────────────────────
  {
    ...
    metaDesc: 'Honest birthday gifts for dads, husbands, and brothers. Every pick hand-chosen.',
  },
  {
  ...
  },
  {
    ...
    metaTitle: 'Wedding Gift Ideas — Picks That Last | Boss Daddy',
    metaDesc: 'Wedding gift ideas chosen for actual home life. Kitchen, home, and lifestyle picks.',
  },
  {
  ...
  },
  {
    ...
    longBlurb: "Baby shower picks from a real first-time dad. Skip the cute-but-useless stuff — every pick here is something a new parent will actually reach for.",
    metaTitle: "Baby Shower Gift Guide — From a Real First-Time Dad | Boss Daddy",
  ...
  // ── Brand-Themed Seasons ───────────────────────────────────────────────────
  {
    ...
    longBlurb: "Grilling season picks. From entry-level upgrades to splurge gear — picks that earn their spot at the grill.",
    metaTitle: 'Best Grilling Gear — Dad-Picked Gear | Boss Daddy',
    metaDesc: 'Best grilling gear, BBQ tools, and grill upgrades chosen for real backyard cooking.',
  },
  {
    value: 'camping_season', slug: 'camping-season', label: 'Camping Season', emoji: '⛺', group: 'season',
    shortBlurb: 'Family camping gear picked by a real dad.',
    longBlurb: "Camping gear picks for real family trips. Tents, gear, and essentials chosen to survive kids, weather, and weekend chaos.",
    metaTitle: 'Best Camping Gear — Family-Ready Picks | Boss Daddy',
    metaDesc: 'Camping gear chosen for real family trips. Tents, sleep systems, and camp essentials.',
  },
  {
    ...
    metaDesc: 'Workshop, garage, and DIY tool picks from a dad who builds and fixes for real. Power tools and accessories.',
  },
  {
  ...
  // ── Budget Tiers ───────────────────────────────────────────────────────────
  {
    ...
    metaTitle: 'Best Gifts Under $25 — Dad-Picked | Boss Daddy',
  ...
  },
  {
    ...
    metaDesc: "Honest gift ideas under $50 that actually get used. Mid-range, dad-picked.",
  },
  {
    ...
    metaDesc: 'Gift ideas under $100 — premium-feel picks chosen for real use.',
  },
  {
    ...
    metaDesc: "Premium splurge gift ideas for milestones that matter. Heirloom-quality, dad-picked.",
  },
]
