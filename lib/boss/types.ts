...
// The Boss is a tool-less chat today (site-content tools retired 2026-09-24 —
// restore from the `boss-concierge-tools-v1` git tag). Nothing produces blocks
// now, but members' saved conversations from the tool era carry them in
// boss_messages.citations, so the types and the BossBlocks renderer stay to
// display that history. When tools return, they stream blocks again.
//
